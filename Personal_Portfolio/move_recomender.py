...
this program will let you pick with genre, actors, and ect things you like
it will print out the things you wanna see or if you wanna see the whole list you can
""")
    ans = input("\ndo you wanna see it in the works (y/n):")
    if ans == "yes" or "y":
        load_movies()
    if ans == "no" or "n":
        personal_portfolio()
